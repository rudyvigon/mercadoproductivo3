...
export async function GET(req: Request) {
  try {
    ...
    // Obtener IDs y recalcular conteo de productos publicados para visibilidad pública
    const sellerIds = (data || []).map((row: any) => row.seller_id);
    // Recalcular conteo de productos publicados por vendedor
    ...
    // Obtener conteo de likes para los vendedores listados
